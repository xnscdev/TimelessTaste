...
class App extends React.Component {
    ...
    createUserWithEmailAndPassword(auth, email, password).catch((err) => {
      ...
      switch (err.code) {
        case "auth/email-already-in-use":
          msg =
            "Email already in use. If you already have an account, please sign in instead.";
          break;
        case "auth/invalid-email":
          msg = "Invalid email";
          break;
  ...
  render() {
    ...
    switch (this.state.page) {
      case Page.SignIn:
        return (
          <SignInForm
            ...
            register={() => this.changePage(Page.Register)}
      ...
      case Page.Register:
        return (
          <RegisterForm
            ...
            signIn={() => this.changePage(Page.SignIn)}
      ...
      default:
        element = (
          <div className="flex text-5xl h-screen justify-center items-center text-red-500">
            Invalid page
          </div>
        );
    }
